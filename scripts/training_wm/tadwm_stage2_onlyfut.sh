...
CHECKPOINT="/data/worlddrive/navsim/exp/ckpt/cogvideox_tadwm_navsim_onlyfut_20wpt/tvar_35000.pkl"
...
rlaunch --cpu=60 --gpu 8 --memory=$((1024 * 300))  \
        ...
        -- /jobutils/scripts/torchrun.sh  /data/worlddrive/navsim/scripts/training_wm/train_deepspeed_cogvideox_nuplan_ft_navsim_onlyfut.py \
        --batch_size 1 \
        --lr 2e-5 \
        --exp_name "cogvideox_tadwm_navsim_onlyfut_20wpt" \
